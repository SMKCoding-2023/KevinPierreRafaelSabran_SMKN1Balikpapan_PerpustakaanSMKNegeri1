    ...
    <header class="w-full border-b border-slate-200 py-6">
        <div class="container">
            <div class="flex justify-between items-center">
                <div>
                <NuxtLink to="/" class="text-xl font-bold mx-5">Perpustakaan SMK Negeri 1 Balikpapan</NuxtLink></div>
                <nav class="flex items-center gap-6">
                    <NuxtLink to="/" class="text-base">Beranda</NuxtLink>
                    <NuxtLink to="/cart" class="text-base">Keranjang</NuxtLink>
                    <NuxtLink to="/about-us" class="text-base">Tentang Kami</NuxtLink>
                    <NuxtLink to="/product" class="text-base">Manajemen</NuxtLink>
