        ...
        <div class="w-[500px]">
            ...
            <form @submit.prevent="submitCategory">
                <div class="mb-6">
                    ...
                    <input type="text" id="name" v-model="form.name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Masukan Nama Category" required>
                </div>
